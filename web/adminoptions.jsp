<%-- 
    ...
    Created on : Dec 23, 2019, 9:57:59 AM
    Author     : Win7
--%>
...
<html>
    ...
    <body>
        <%
            ...
            displayBlock.append("<div id='dv2' onclick='redirectadminvotingpage()'><img src='images/voteadmin.jpg' height='300px' width='300px'><br><h3>Voting Page</h3></div>");
