<%-- 
    Document   : showadmincandidate
    Created on : 15 Jan, 2020, 2:37:51 PM
    Author     : HP
--%>

<%@page contentType="text/html" pageEncoding="UTF-8" import="java.util.*,evoting.dto.CandidateDto,evoting.dao.UserDao"%>
<html>
    <head>
    ...
    <body>
     <%
        ...
        if(userid==null)
          ...
          System.out.println("show admin candidate jsp");
          ...
          for(CandidateDto c: candidateList) {
