 ...
 * @author HP
 */
public class UpdateSingleCandidateControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            System.out.println("UpdateSingleCandidateControllerServlet try \n");
            ...
            for(FileItem item : multiparts) {
                if(item.isFormField()) {
                    i++;
                    System.out.println("Update single cont ka if chla\n\n");
                    ...
                    i++;
                    System.out.println("Update single controlel servlet ka else chla\n\n");
                    String fieldName = item.getFieldName();
            ...
            System.out.println(objValues.get(0)+","+objValues.get(1)+","+ objValues.get(2)+","+ fileContent);
            AddCandidateDto candidate = new AddCandidateDto(objValues.get(0), objValues.get(1), objValues.get(2), fileContent);
